...
with app.app_context():
    ...
    users = [
        {'username': 'ariellebernstein', 'email': 'abernst5@umd.edu', 'first_name':'Arielle', 'last_name':'Bernstein',
            'password': generate_password_hash('password12', method='sha256'), 'role':'STUDENT'},
